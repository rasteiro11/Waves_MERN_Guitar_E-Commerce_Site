                ...
                <div className="shop_wrapper">
                    <div className="left">
                        ...
                        <CollapseCheckbox
                            initState={true}
                            title="Frets"
                            list={[{ _id: 20, name: 20 }, { _id: 21, name: 21 }, { _id: 22, name: 22 }, { _id: 24, name: 24 }]}
                            handleFilters={(filters) => handleFilters(filters, 'frets')}
                        />
                        <RangeSelect title="Price range" handleRange={(values) => handleRanges(values)} />
                    </div>
                    <div className="right">
