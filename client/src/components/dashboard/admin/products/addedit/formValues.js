...
export const validation = () => (
    Yup.object({
        ...
        frets: Yup.number().required('Sorry, the frets is required').oneOf([20, 21, 22, 24], "Only 20, 21, 22, 24 are allowed"),
        ...
        price: Yup.number().required('Sorry, the price is required').min(1, 'Sorry the min is 1').max(1000000, 'Sorry the max is 1000000'),
